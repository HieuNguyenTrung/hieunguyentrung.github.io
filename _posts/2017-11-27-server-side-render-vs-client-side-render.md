---
layout: post
title: Client side render vs Server side render
tags: server render
summary: Tìm hiểu và so sánh giữa Client side render và Server side render
---
...
![enter image description here](https://cdn-images-1.medium.com/max/800/1*jJkEQpgZ8waQ5P-W5lhxuQ.png)
